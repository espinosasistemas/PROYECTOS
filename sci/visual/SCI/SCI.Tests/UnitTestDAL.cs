...
namespace SCI.Tests
{
    ...
    public class UnitTestDAL
    {
        ...
        public void TestLog()
        {
            ...
            log aModificar = logRepository.SearchById(idLogNuevo);
            ...
            {
                Assert.IsTrue(logRepository.Delete(item.IdMovimiento), logRepository.Error);
            }
        ...
        public void TestClient()
        {
            ...
            cliente aModificar = clienteRepository.SearchById(idClienteInsertado);
            ...
            {
                Assert.IsTrue(clienteRepository.Delete(item.IdCliente), clienteRepository.Error);
        ...
        public void TestStatusViaje()
        {
            ...
            statusviaje aModificar = statusRepository.SearchById(idStatusInsertado);
            ...
            {
                Assert.IsTrue(statusRepository.Delete(item.IdStatus), statusRepository.Error);
            }
        }
