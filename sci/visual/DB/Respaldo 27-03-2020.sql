CREATE DATABASE  IF NOT EXISTS `db_sci` /*!40100 DEFAULT CHARACTER SET latin1 */;
USE `db_sci`;
...
INSERT INTO `cortesoperador` VALUES (18,'2020-03-22 23:00:00','2020-03-24 06:00:00',775,31,12,1,297),(19,'2020-03-22 21:00:00','2020-03-24 06:00:00',825,33,7,1,296),(21,'2020-03-22 23:30:00','2020-03-24 06:00:00',762.5,30.5,15,4,295),(22,'2020-03-22 22:00:00','2020-03-24 06:00:00',640,32,21,1,294),(23,'2020-03-23 06:00:00','2020-03-24 10:15:00',706.25,28.25,6,4,298),(24,'2020-03-26 05:00:00','0001-01-01 00:00:00',0,0,17,1,318);
...
CREATE TABLE `factura` (
  ...
  `tipoDeViaje` varchar(10) NOT NULL,
  `loadLeg` varchar(20) NOT NULL,
  `facturaAlms` varchar(20) NOT NULL,
  `usuario` varchar(30) NOT NULL,
  `cartaPorte` varchar(50) NOT NULL,
  `trackId` varchar(50) NOT NULL,
  `usoCfdi` varchar(20) NOT NULL,
  `metodoDePago` varchar(20) NOT NULL,
  `formaDePago` varchar(20) NOT NULL,
  `condicionesDePago` varchar(20) NOT NULL,
  `regimenFiscal` varchar(20) NOT NULL,
  `fechaDeFactura` datetime NOT NULL,
  `fechaFacturaAlms` datetime NOT NULL,
  `fechaDeRecibido` datetime NOT NULL,
  `fechaDePagoPromesa` datetime NOT NULL,
  ...
  KEY `foreing_k0_idx` (`idCliente`),
  CONSTRAINT `foreing_k0` FOREIGN KEY (`idCliente`) REFERENCES `cliente` (`idcliente`) ON DELETE NO ACTION ON UPDATE NO ACTION
...
-- Dump completed on 2020-03-27 13:06:57
