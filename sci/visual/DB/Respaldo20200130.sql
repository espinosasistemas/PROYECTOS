...
INSERT INTO `caseta` VALUES (3,'Caseta de San Martín Texmelucan Trailer',400,1,3),(4,'Caseta de San Martín Texmelucan Torthon',300,2,3),(5,'Caseta de San Martín Texmelucan Camioneta',200,3,3),(6,'Caseta de San Martín Texmelucan Pickup',100,4,3);
...
CREATE TABLE `cortesoperador` (
  ...
  PRIMARY KEY (`idCorte`),
  KEY `cortesOperacion_fk1` (`idViajeOps`),
  CONSTRAINT `cortesOperacion_fk1` FOREIGN KEY (`idViajeOps`) REFERENCES `viaje` (`idViajeOps`)
...
INSERT INTO `cortesoperador` VALUES (1,'2020-01-28 08:00:00','2020-01-29 19:59:00',8999.93,3);
...
INSERT INTO `gasolineria` VALUES (4,'Gasolinería Finsa','Parque Finsa2',2);
...
-- Dump completed on 2020-01-30 16:05:02
